...
export function Portfolio() {
  ...
  return (
    <div className="min-h-screen relative z-0">
      ...
      <div className="pt-32 md:pt-40 pb-12 md:pb-16 px-6 border-b border-white/10 text-center relative overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[50vw] md:w-[30vw] h-[50vw] md:h-[30vw] bg-neon-cyan/10 rounded-full blur-[80px] md:blur-[100px] pointer-events-none -z-10"></div>
      ...
      {loading ? (
        ...
        <div className="py-32 md:py-40 text-center flex flex-col items-center">
        ...
        <div className="flex flex-col container mx-auto px-6 py-16 md:py-20 gap-16 md:gap-24">
          {items.map((item, index) => (
            <div key={item.id} className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 items-center group">
              <div className="md:col-span-4 p-6 md:p-8 glass-dark rounded-2xl relative overflow-hidden hover:border-neon-cyan transition-colors duration-500">
