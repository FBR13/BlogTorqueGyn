...
export function Header() {
  ...
  return (
    <header className="w-full sticky top-0 left-0 bg-black/80 backdrop-blur-xl z-50 transition-all duration-300">
        ...
        <div className="flex flex-col items-center w-full px-8 pb-4">
          {navLinks.map((link) => (
            <Link
              ...
              className={`text-[11px] font-display font-bold tracking-[0.3em] uppercase w-full text-center py-5 border-b border-white/5 ${
